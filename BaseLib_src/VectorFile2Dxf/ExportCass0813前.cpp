...
//		fprintf(m_fp,"%.3lf,%.3lf,1.00\n", x, y); //x, y，比例 //  [6/8/2018 jobs]
	...
	if( ptsum>2 )  // >=  [6/20/2018 jobs]
	{
		...
		}else if (strcmp(m_CurLayer,"JJ") == 0 )
		{
			...
			fprintf(m_fp,"SJY,0:\n");
			fprintf(m_fp,"GXRQ,0:\n");
		}else if (strcmp(m_CurLayer,"ASSIST") == 0)
		{
			fprintf(m_fp,"UNAME,0:\n");
			fprintf(m_fp,"MC,0:\n");
			fprintf(m_fp,"STBM,0:\n");
...
void CExportCass::LoadCass()
{
	...
	mapCass.insert(std::make_pair("320201_2", "DLDW"));//	DLDW==320201 
	...
	mapCass.insert(std::make_pair("321503_0", "DLDW"));//	DLDW==321503
	mapCass.insert(std::make_pair("321503_2", "DLDW"));//	DLDW==321503
	mapCass.insert(std::make_pair("321504_0", "DLDW"));//	DLDW==321504 
	mapCass.insert(std::make_pair("321505_0", "DLDW"));//	DLDW==321505 
	mapCass.insert(std::make_pair("321506_2", "DLDW"));//	DLDW==321506  
	...
	mapCass.insert(std::make_pair("370105_0", "DLDW"));//	DLDW==370105 
	...
	mapCass.insert(std::make_pair("740200_0", "DMTZ"));//	DMTZ==740200 
	mapCass.insert(std::make_pair("321200_0", "DMTZ"));//	DMTZ==321200 
	mapCass.insert(std::make_pair("320400_0", "DMTZ"));//	DMTZ==320400 

	mapCass.insert(std::make_pair("220900_0", "ASSIST"));//	依比例涵洞骨架线	165101	ASSIST  220900_0
	mapCass.insert(std::make_pair("220900_1", "DLSS"));//	不依比例涵洞

	mapCass.insert(std::make_pair("450502_0", "ASSIST"));//	ASSIST==450502 
...
void CExportCass::LoadCassBM()
{
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	简单房屋	141200	JMD	
	...
	mapCassBM.insert(std::make_pair("311001_2", "142111"));//	依比例地上窑洞	142111	JMD	311001
	mapCassBM.insert(std::make_pair("311001_0", "142112"));//	地上窑洞不依比例	142112	JMD	
	mapCassBM.insert(std::make_pair("311001_1", "142113"));//	房屋式窑洞	142113	JMD	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	无墙壁柱廊	143111	JMD	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	柱廊有墙壁边	143112	JMD	
	...
	mapCassBM.insert(std::make_pair("380404_0", "143301-1"));//	台阶线	143301-1	JMD	380404
	//mapCassBM.insert(std::make_pair(110402, 134100));//	室外楼梯骨架线	143400	ASSIST	
	...
	mapCassBM.insert(std::make_pair("380408_0", "143911_10"));//	依比例支柱.墩(虚线)	143911	JMD	
	...
	mapCassBM.insert(std::make_pair("320902_0", "151300"));//	探槽	151300	DLDW	320902
	mapCassBM.insert(std::make_pair("320201_0", "151401"));//	开采的竖井井口(圆)	151401	DLDW	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	开采的竖井井口(方)	151411	DLDW	
	mapCassBM.insert(std::make_pair("320202_0", "151402"));//	开采的斜井井口	151402	DLDW	320202
	mapCassBM.insert(std::make_pair("320202_1", "151402"));//	开采的斜井井口	151402	DLDW	320202
	//mapCassBM.insert(std::make_pair(110402, 134100));//	开采的平洞洞口	151403	DLDW	
	mapCassBM.insert(std::make_pair("320204_0", "151404"));//	开采的小矿井	151404	DLDW	320204
	//mapCassBM.insert(std::make_pair(110402, 134100));//	废弃的竖井井口(圆)	151501	DLDW	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	废弃的竖井井口(方)	151511	DLDW	
	mapCassBM.insert(std::make_pair("320700_2", "151502"));//	废弃的斜井井口	151502	DLDW	320700_2
	mapCassBM.insert(std::make_pair("320700_3", "151503"));//	废弃的平洞洞口	151503	DLDW	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	龙门吊骨架线	152210	ASSIST	321502
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	天吊骨架线	152220	ASSIST	
	...
	mapCassBM.insert(std::make_pair("321503_2", "152220-4"));//	天吊柱架	152220-4	DLDW	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	地面上的传送带骨架线	152320	ASSIST	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	滑槽右侧	152501	DLDW	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	滑槽左侧	152502	DLDW	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	水塔范围	152621	DLDW	
	mapCassBM.insert(std::make_pair("321105_1", "152630"));//	水塔烟囱	152630	DLDW	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	水塔烟囱范围	152631	DLDW	
	mapCassBM.insert(std::make_pair("321106_1", "152700"));//	烟囱	152700	DLDW	321106
	//mapCassBM.insert(std::make_pair(110402, 134100));//	烟囱范围	152701	DLDW	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	依比例液体.气体储存设备(非圆)	152812	DLDW	
	...
	mapCassBM.insert(std::make_pair("370105_0", "154300"));//	环保检测站	154300	DLDW	370105
	...
	mapCassBM.insert(std::make_pair("380502_3", "155224"));//	塔式照射灯	155224	DLDW	
	...
	mapCassBM.insert(std::make_pair("340602_1", "155500"));//	垃圾台	155500	DLDW	340602
	...
	mapCassBM.insert(std::make_pair("340504_0", "155810"));//	电视发射塔	155800	DLDW	340504
	...
	mapCassBM.insert(std::make_pair("321506_2", "158400"));//	地磅	158400	DLDW	321506
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	堆式窑	158601	DLDW	
	...
	mapCassBM.insert(std::make_pair("321300_0", "158603"));//	窑	158602	DLDW	321300
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	独立坟范围	158711	DLDW	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	坟群边界	158702	DLDW	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例涵洞	165102	DLSS	
	...
	mapCassBM.insert(std::make_pair("451004_2", "165302"));//	未加固路堑	165302	DLSS	
	...
	mapCassBM.insert(std::make_pair("460404_0", "168202"));//	右岸航行浮标	168202	DLSS	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	过江管线标	168500	DLSS	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	地面上的输电线骨架线	171101	ASSIST	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	地面下的输电线	171102	GXYZ	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	输电线电缆标	171103	GXYZ	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	地面上的配电线骨架线	171201	ASSIST	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	地面下的配电线	171202	GXYZ	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	电线杆上变压器(单杆)	171610	GXYZ	
	...
	mapCassBM.insert(std::make_pair("210101_1", "181101"));//	常年河水涯线	181101	SXSS	210101
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	垅	184602	SXSS	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例丛礁(明礁)	186813	SXSS	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	危险区域(明礁)	186814	SXSS	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	依比例干出礁	186821	SXSS	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例单个干出礁	186822	SXSS	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例丛礁(干出礁)	186823	SXSS	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例单个适淹礁	186832	SXSS	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例丛礁(适淹礁)	186833	SXSS	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例单个暗礁	186842	SXSS	
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例丛礁(暗礁)	186843	SXSS	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	梯田坎	204300	DMTZ	
	...
	//mapCassBM.insert(std::make_pair(110402, 134100));//	不依比例土堆	205503	DMTZ	
	...
	mapCassBM.insert(std::make_pair("810502_1", "213401"));//	单个未成林符号一	213401	ZBTZ	
	...
	mapCassBM.insert(std::make_pair("810602_3", "214201"));//	单个改良草地符号一	214201	ZBTZ	
