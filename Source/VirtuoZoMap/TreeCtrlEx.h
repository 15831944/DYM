...
const UINT WM_CHECK_CHANGE_CMD = ::RegisterWindowMessage("TreeCheckChangedMsg");
///////////////////////////////////////////////////////////////////////////// 
// CTreeCtrlEx window 
...
public: 
	...
	BOOL Itemexpanding(NMHDR* pNMHDR, LRESULT* pResult) { return OnItemexpanding(pNMHDR, pResult); }; 
