...
// VirtuoZoMapView.h : CSpVctView2 类的接口
//

#pragma once
#include "SpGLImgView.h"

class CSpVctView2 : public CSpGLImgView
{
protected: // 仅从序列化创建
	CSpVctView2();
	DECLARE_DYNCREATE(CSpVctView2)
...
public:
	...
	void AutoZoomView(double zoomRate);
	// 操作
public:
